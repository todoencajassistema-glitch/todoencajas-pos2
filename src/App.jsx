            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18}}>
              ...
              <div style={{display:"flex",gap:8}}>
                ...
                <button className="btn btn-dark" style={{fontSize:12}} onClick={()=>{
                  ...
                  parts.push('.card{background:#fff;border:1px solid #ede8e0;border-radius:8px;padding:8px;text-align:center;page-break-inside:avoid}');
                  parts.push('.sku{font-size:7pt;color:#888;margin-bottom:2px}');
                  parts.push('.nombre{font-size:8pt;font-weight:700;color:#1a1a1a;margin-bottom:2px;line-height:1.2}');
                  parts.push('.precio{font-size:9pt;font-weight:700;color:#E8681A}');
                  parts.push('.ubicacion{font-size:7pt;color:#888;margin-top:1px}');
                  parts.push('@media(min-width:600px){.grid{grid-template-columns:repeat(4,1fr)}}');
                  ...
                  prods.forEach(p=>{
                    ...
                    parts.push('<img src="'+qrUrl+'" style="width:80px;height:80px;max-width:100%" alt="QR"/>');
